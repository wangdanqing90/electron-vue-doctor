  ...
  <div class="container">
    ...
    <div class="inform-container">
      <div class="inform-inner display_flex justify-content_flex-justify align-items_center">
        ...
        <div class="right">
          <div
            class="adjust-container"
            :class="activeRightClass == index ? item.colorClass:''"
            v-for="(item,index) in adjustList"
            :key="index"
            @click="selectClick(index)"
          >
            <div class="top">
              <img :src="item.activeRightClass?item.selectedImg:item.unselectedImg" />
              <div>{{item.title}}</div>
            </div>
            <div class="bottom">
              <Adjust :class="item.colorClass"></Adjust>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    selectClick(index) {
      this.activeRightClass = index; // 把当前点击元素的index，赋值给activeClass
    }
  },
  watch: {}
};
