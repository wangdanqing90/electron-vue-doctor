  ...
  <div class="container">
    ...
    <div class="inform-container">
      <div class="inform-inner display_flex justify-content_flex-justify align-items_center">
        ...
        <div class="right">
          <Adjust
            :selectedImg="adjustList[0].selectedImg"
            :unselectedImg="adjustList[0].unselectedImg"
            :title="adjustList[0].title"
            :width="adjustList[0].width"
            :class="adjustList[0].active?adjustList[0].colorClass:''"
            :active="adjustList[0].active"
          ></Adjust>

          <Adjust
            :selectedImg="adjustList[1].selectedImg"
            :unselectedImg="adjustList[1].unselectedImg"
            :title="adjustList[1].title"
            :width="adjustList[1].width"
            :class="adjustList[1].active?adjustList[1].colorClass:''"
          ></Adjust>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      adjustList: [
        {
          selectedImg: require("@/../images/followmode_0.png"),
          unselectedImg: require("@/../images/followmode_2.png"),
          title: "跟随模式",
          width: "210px",
          colorClass: "pinkFontColor",
          active: true
